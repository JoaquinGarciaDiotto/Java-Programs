...
public class Cola_con_arreglo_circular<E> implements Queue<E>{
	...
	/**
	 * Constructor N1 de la clase "Con_con_arreglo_circular". Crea una nueva cola de tamaño 10.
	 */
	...
	/**
	 * Constructor N2 de la clase "Cola_con_arreglo_circular". Crea una nueva cola de tamaño n.
	...
	/**
	 * Metodo privado para aumentar el tamaño de la Cola en 10 espacios.
	 */
